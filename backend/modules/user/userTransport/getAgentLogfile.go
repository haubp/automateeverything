...
func GetAgentLogFile(appCtx component.AppContext) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		var file, err = os.OpenFile(fmt.Sprintf("./fileRepository/nodes/agentLog/%s", data.NodeId), os.O_RDWR, 0644)
